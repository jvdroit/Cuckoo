...
######  INFO 
## tested on Ubuntu 14.04.2 LTS with graphical interface. no services added. 
######

NEEDED_PKGS="linux-headers-generic python python-dev python-sqlalchemy python-bson python-pefile python-bottle libpcre3 libpcre3-dev autoconf libtool tcpdump python-magic python-dpkt py$
...
while true; do
    ...
    case $yn in
        [Yy]* ) rm $DIR/virtualbox-4.2_4.2.10-84104~Ubuntu~precise_amd64.deb; rm $DIR/Oracle_VM_VirtualBox_Extension_Pack-4.2.10.vbox-extpack; rm /var/www/phpvirtualbox-4.2-4.zip; rm /u$
        [Nn]* ) break;;
        * ) echo "Please answer yes or no.";;
    esac
done
...
echo "you may add ./cuckoo/utils/community.py -wafb monitor."
echo " Have Nice Day"
